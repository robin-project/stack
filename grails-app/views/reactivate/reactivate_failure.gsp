		...
		<div>
			<div class="span12 pull-left">
				...
				<g:if test="${flash.message}">
	                <div class="message" role="status"><font color="red">${flash.message}</font></div>
	            </g:if>
				<div>
					<strong><g:message code="reactivate.failure.msg1.1"/>&nbsp;<a><%=request.getParameter("email") %></a><g:message code="reactivate.failure.msg1.2"/></strong>
				</div>
