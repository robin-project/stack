<!-- Modal viewRequest-->
<g:form id="formAliasConfig">
	<div id="aliasConfig" class="modal hide">
		...
		<div class="modal-footer">
			...
			<button class="btn span3 pull-right" onclick="callQueryUsers(${currentPage }, ${pageCounts},queryParams)" data-dismiss="modal"
				aria-hidden="true">
